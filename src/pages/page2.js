...
// if(location.state.Movies.length!=0||location.state.Shows.length!=0){
...
var Mediatype
    const getDetails = async() => {
        ...
        try{
            ...
            await fetch("https://api.themoviedb.org/3/"+ Mediatype +"/"+ id +"?&append_to_response=videos&api_key=270c888e1f149bd091cc6cef96fb175d")
            .then(res => res.json())
